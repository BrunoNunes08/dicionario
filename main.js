...
palavras.forEach((palavra) => {
    ...
    palavra.addEventListener("click", (e) => {
        ...
        palavraPortugues.textContent = informacoes[valor.toLowerCase()].traducao;

        const explicacaoIngles = document.querySelector(".explicacao-ingles");
        explicacaoIngles.textContent = informacoes[valor.toLowerCase()].descricaoIngles;
        
        const explicacaoPortugues = document.querySelector(".explicacao-portugues");
        explicacaoPortugues.textContent = informacoes[valor.toLowerCase()].descricaoPortugues;
...
btnAudioIngles.addEventListener("mouseover", (e) => {
